    ...
    <b-container fluid>
            ...
            <b-col lg="6" class="my-1">
                ...
                >
                    ...
                    >
                        ...
                        <b-form-checkbox value="ext_id">Eks ID</b-form-checkbox>
                        <b-form-checkbox value="posting_flag">Flag Posting</b-form-checkbox>
                        <b-form-checkbox value="account_usage_flag">Penggunaan Flag Account</b-form-checkbox>
                    </b-form-checkbox-group>
                </b-form-group>
            </b-col>
        ...
        <!-- <b-row style="margin-top:5%;margin-left:5%;margin-right:5%;"> -->
            <b-navbar toggleable="lg" type="light" variant="info">
                <span class="fs-4">Msg Type ==> {{ totalRows }} Baris</span>
            </b-navbar>
        <!-- </b-row> -->
...
module.exports = {
    data() {
        return {
            ...
            fields: [
                ...
                {
                    key: 'account_usage_flag',
                    label: 'Penggunaan Flag Account',
                    sortable: true
                }
            ],
            filter: null,
    ...
    methods: {
        retrieveData(date){
            axios.post(this.menu,{ jenis: 'MsgType', limit: false})
            .then((resp) => { 
