    ...
    <b-container fluid>
            ...
            <b-col lg="6" class="my-1">
                ...
                >
                    <b-form-checkbox-group
                        ...
                        class="mt-1"
                    >
                        <b-form-checkbox value="state_Type">Kode</b-form-checkbox>
        ...
        <!-- <b-row style="margin-top:5%;margin-left:5%;margin-right:5%;"> -->
            <b-navbar toggleable="lg" type="light" variant="info">
                <span class="fs-4">State Type ==> {{ totalRows }} Baris</span>
            </b-navbar>
        <!-- </b-row> -->
...
module.exports = {
    ...
    methods: {
        retrieveData(date){
            axios.post(this.menu,{ jenis: 'StateType', limit: false})
            .then((resp) => { 
