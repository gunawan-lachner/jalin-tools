    ...
    <b-container fluid>
            ...
            <b-col lg="6" class="my-1">
                ...
                >
                    <b-form-checkbox-group
                        ...
                        class="mt-1"
                    >
                        <b-form-checkbox value="id">Kode</b-form-checkbox>
        ...
        <!-- <b-row style="margin-top:5%;margin-left:5%;margin-right:5%;"> -->
            <b-navbar toggleable="lg" type="light" variant="info">
                <span class="fs-4">Pan Entry ==> {{ totalRows }} Baris</span>
            </b-navbar>
        <!-- </b-row> -->
...
module.exports = {
    ...
    methods: {
        retrieveData(date){
            axios.post(this.menu,{ jenis: 'PanEntry', limit: false})
            .then((resp) => { 
