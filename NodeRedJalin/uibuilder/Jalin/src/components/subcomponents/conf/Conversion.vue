    ...
    <b-container fluid>
            ...
            <b-col lg="6" class="my-1">
                ...
                >
                    <b-form-checkbox-group
                        ...
                        class="mt-1"
                    >
                        <b-form-checkbox value="cType">Jenis</b-form-checkbox>
                        <b-form-checkbox value="mapfrom">Maping dari</b-form-checkbox>
                        <b-form-checkbox value="mapto">Maping ke</b-form-checkbox>
                        <b-form-checkbox value="pluginName">Nama Plguin</b-form-checkbox>
                    </b-form-checkbox-group>
                </b-form-group>
            </b-col>
        ...
        <!-- <b-row style="margin-top:5%;margin-left:5%;margin-right:5%;"> -->
            <b-navbar toggleable="lg" type="light" variant="info">
                <span class="fs-4">Conversion ==> {{ totalRows }} Baris</span>
            </b-navbar>
        <!-- </b-row> -->
        <b-table striped hover 
            ...
            small
            @filtered="onFiltered">
            <template #cell(containerPluginName)="data">
...
module.exports = {
    ...
    mounted(){
        console.log('mounted Convertion');
        this.database = [];
        this.checkMysql();
    ...
    methods: {
        retrieveData(date){
            axios.post(this.menu,{ jenis: 'Conversion', limit: false})
            .then((resp) => { 
